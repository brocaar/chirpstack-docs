...
are provisioned on the same [Network Server](network-servers.md)
as the [Service Profile](service-profiles.md) which is assigned
to the [Application](applications.md) above the device.
