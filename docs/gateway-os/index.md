...
![gateway-config](/static/img/gateway-os/gateway-config.png)
...
Provides a full [ChirpStack Network Server](../network-server/index.md) and [ChirpStack Application Server](../application-server/index.md)
